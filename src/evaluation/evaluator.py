...
from src.evaluation.metrics import generation_period_metrics, normalization_scale_from_config, regression_metrics
...
def evaluate_run(label: str, run_dir: str | Path, split: str = "test") -> EvaluationResult:
    ...
    metrics = regression_metrics(
        ...
        normalization_scale_value=metric_scale,
    )
    generation_metrics = generation_period_metrics(predictions, normalization_scale_value=metric_scale)
